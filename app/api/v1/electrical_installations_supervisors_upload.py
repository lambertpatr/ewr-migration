...
from app.services.electrical_supervisors_import_service import (
    import_electrical_supervisors_via_staging_copy,
)
...
def _run_job(job_id: str, df, source_file_name: str):
    ...
    try:
        ...
        result = import_electrical_supervisors_via_staging_copy(
            db,
            df,
            source_file_name=source_file_name,
...
def upload_supervisors_work_experience(
    ...
    """Upload supervisors/work experience Excel.
