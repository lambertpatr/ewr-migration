...
from app.services.supervisor_details_import_service import (
    import_supervisor_details_via_staging_copy,
)
...
def get_supervisor_details_job_status(job_id: str):
    if job_id not in _job_status:
        raise HTTPException(status_code=404, detail="Job not found")
    return _job_status[job_id]


@router.get("/supervisor-details-jobs")
def list_supervisor_details_jobs():
    return _job_status
